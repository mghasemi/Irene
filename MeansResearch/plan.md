...
- Next execution sprint:
	...
	7. Immediate next: choose the next theory-facing work package from the open-problem set (OP1 solver-escalation strategy, OP2 theorem-level support-sensitive criterion, or OP3 mathematical boundary characterization).
**Steps**

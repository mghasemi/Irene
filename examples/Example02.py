...
print("__" * 20)
print("Moment of %s = " % str(f + g), Rlx.Solution.TruncatedMmntSeq[f] + Rlx.Solution.TruncatedMmntSeq[g])
print("Moment of %s = " % str(g ** 2 + .25 * k - .6),
      Rlx.Solution.TruncatedMmntSeq[g ** 2] + .25 * Rlx.Solution.TruncatedMmntSeq[k] - .6)
